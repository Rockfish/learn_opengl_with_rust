...
use learnopengl_lib::{c_string, gl_get_uniform_location, size_of_float};
use std::ffi::CString;
use std::mem;
...
fn main() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            let angle = (glfw.get_time() * 20.0).to_radians() as f32;

            model = model * Mat4::from_axis_angle(Vec3::new(0.5, 1.0, 0.0), angle);
