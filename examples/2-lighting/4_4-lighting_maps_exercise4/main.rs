...
fn main() {
    ...
    lightingShader
        .build(
            "examples/2-lighting/4_4-lighting_maps_exercise4/4_4-lighting_maps.vert",
            "examples/2-lighting/4_4-lighting_maps_exercise4/4_4-lighting_maps.frag",
        )
        .unwrap();
    ...
    lightCubeShader
        .build(
            "examples/2-lighting/4_4-lighting_maps_exercise4/4_4-light_cube.vert",
            "examples/2-lighting/4_4-lighting_maps_exercise4/4_4-light_cube.frag",
        )
        .unwrap();
