...
fn main() {
    ...
    lightingShader
        .build(
            "examples/2-lighting/2_4-basic_lighting_exercise2/2_4-basic_lighting_exercise2.vert",
            "examples/2-lighting/2_4-basic_lighting_exercise2/2_4-basic_lighting_exercise2.frag",
        )
        .unwrap();
