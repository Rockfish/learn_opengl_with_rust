...
fn main() {
    ...
    let lightingShader = Shader_M::new(
        "examples/2-lighting/3_1-materials/3_1-materials.vert",
        "examples/2-lighting/3_1-materials/3_1-materials.frag",
    )
    .unwrap();

    let lightCubeShader = Shader_M::new(
        "examples/2-lighting/3_1-materials/3_1-light_cube.vert",
        "examples/2-lighting/3_1-materials/3_1-light_cube.frag",
    )
    .unwrap();
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            let diffuseColor = lightColor * vec3(0.5, 0.5, 0.5); // decrease the influence
            let ambientColor = lightColor * vec3(0.2, 0.2, 0.2); // low influence
            ...
            // material properties
            lightingShader.setVec3_xyz("material.ambient", 1.0, 0.5, 0.31);
            lightingShader.setVec3_xyz("material.diffuse", 1.0, 0.5, 0.31);
            lightingShader.setVec3_xyz("material.specular", 0.5, 0.5, 0.5); // specular lighting doesn't have full effect on this object's material
