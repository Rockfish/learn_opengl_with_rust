...
fn main() {
    ...
    lightingShader
        .build(
            "examples/2-lighting/3_2-materials_exercise1/3_2-materials.vert",
            "examples/2-lighting/3_2-materials_exercise1/3_2-materials.frag",
        )
        .unwrap();
    ...
    lightCubeShader
        .build(
            "examples/2-lighting/3_2-materials_exercise1/3_2-light_cube.vert",
            "examples/2-lighting/3_2-materials_exercise1/3_2-light_cube.frag",
        )
        .unwrap();
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            // light properties
            lightingShader.setVec3_xyz("light.ambient", 1.0, 1.0, 1.0); // note that all light colors are set at full intensity
            lightingShader.setVec3_xyz("light.diffuse", 1.0, 1.0, 1.0);
            lightingShader.setVec3_xyz("light.specular", 1.0, 1.0, 1.0);

            // material properties
            lightingShader.setVec3_xyz("material.ambient", 0.0, 0.1, 0.06);
            lightingShader.setVec3_xyz("material.diffuse", 0.0, 0.5098039, 0.5098039);
            lightingShader.setVec3_xyz("material.specular", 0.50196078, 0.50196078, 0.50196078);
