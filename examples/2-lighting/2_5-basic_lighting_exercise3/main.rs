...
fn main() {
    ...
    let lightingShader = Shader_M::new(
        "examples/2-lighting/2_5-basic_lighting_exercise3/2_5-basic_lighting_exercise3.vert",
        "examples/2-lighting/2_5-basic_lighting_exercise3/2_5-basic_lighting_exercise3.frag",
    )
    .unwrap();
