...
fn main() {
    ...
    lightingShader
        .build(
            "examples/2-lighting/5_1-light_casters_directional/5_1-light_casters.vert",
            "examples/2-lighting/5_1-light_casters_directional/5_1-light_casters.frag",
        )
        .unwrap();
    ...
    lightCubeShader
        .build(
            "examples/2-lighting/5_1-light_casters_directional/5_1-light_cube.vert",
            "examples/2-lighting/5_1-light_casters_directional/5_1-light_cube.frag",
        )
        .unwrap();
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            lightingShader.use_shader();
            lightingShader.setVec3_xyz("light.direction", -0.2, -1.0, -0.3); // Note, setting direction not position
