...
fn main() {
    ...
    lightingShader
        .build(
            "examples/2-lighting/5_3-light_casters_spot/5_3-light_casters.vert",
            "examples/2-lighting/5_3-light_casters_spot/5_3-light_casters.frag",
        )
        .unwrap();
    ...
    lightCubeShader
        .build(
            "examples/2-lighting/5_3-light_casters_spot/5_3-light_cube.vert",
            "examples/2-lighting/5_3-light_casters_spot/5_3-light_cube.frag",
        )
        .unwrap();
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            lightingShader.use_shader();
            lightingShader.setVec3("light.position", &state.camera.Position);
            lightingShader.setVec3("light.direction", &state.camera.Front);
            lightingShader.setFloat("light.cutOff", 12.5f32.to_radians().cos());
            lightingShader.setVec3("viewPos", &state.camera.Position);

            // light properties
            lightingShader.setVec3_xyz("light.ambient", 0.1, 0.1, 0.1);
            ...
            lightingShader.setVec3_xyz("light.diffuse", 0.8, 0.8, 0.8);
            ...
            // let mut model =  Mat4::from_translation(state.lightPos);
